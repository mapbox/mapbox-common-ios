...
let version = "20.1.0-rc.3-b1dc6ad813d20bd73288a64e9344c260484fe2ff-SNAPSHOT"
let checksum = "8d49d3a1adc4fc36bc74e95ccba092ea8dfcc9615b2723e018c08cf18b0a862b"
...
let package = Package(
    ...
    targets: [
        registry.mapboxCommonTarget(version: version, checksum: checksum),
        .testTarget(
...
extension SDKRegistry {
    func mapboxCommonTarget(version: String, checksum: String) -> Target {
        return binaryTarget(name: "MapboxCommon",
                            version: version,
                            path: "mapbox-common",
                            filename: "MapboxCommon.zip",
                            checksum: checksum)
    }
}
