...
```swift
.package(url: "https://github.com/mapbox/mapbox-common-ios.git", from: "24.7.2"),
```

##### CocoaPods 📱🖥💻

```ruby
pod 'MapboxCommon', '24.7.2'
```
...
```bash
binary "https://api.mapbox.com/downloads/v2/carthage/mapbox-common/MapboxCommon.json" == 24.7.2
```
