...
```swift
.package(url: "https://github.com/mapbox/mapbox-common-ios.git", from: "20.1.1"),
```

##### CocoaPods 📱🖥💻

```ruby
pod 'MapboxCommon', '20.1.1'
```
...
```bash
binary "https://api.mapbox.com/downloads/v2/carthage/mapbox-common/MapboxCommon-ios.json" == 20.1.1
```
