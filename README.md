...
```swift
.package(url: "https://github.com/mapbox/mapbox-common-ios.git", from: "1.1.2"),
```

##### CocoaPods 📱🖥💻

```ruby
pod 'MapboxCommon', '1.1.2'
```
...
```bash
binary "https://api.mapbox.com/downloads/v2/carthage/mapbox-common/MapboxCommon.json" == 1.1.2
```
